...
import com.seif.jwt.backend.config.UserAuthProvider;
...
public class AuthController {
    ...
    public ResponseEntity<UserDto> regiter(@RequestBody SignUpDto signUpDto){
    ...
    public String processForgotPassword(@RequestBody String email) {
        ...
        sendForgetPasswordEmail(email, resetPasswordLink);
...
//        return "your password changed succefuly";
//    }
@PostMapping("/reset_password")
public String processResetPassword(@RequestParam String token, @RequestParam String password)  {
    ...
    private String templateEmail() {
        return "<!DOCTYPE html>\n" +
                ...
                "                <img src=\"http://www.annonces.rnu.tn/images/logo/logo_05.jpg\" alt=\"Logo\" border=\"0\" width=\"48\" style=\"display: block; width: 48px; max-width: 48px; min-width: 48px;\">\n" +
                "              </a>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "        </table>\n" +
                ...
                "              <p style=\"margin: 0;\">Tap the button below to confirm your email address. If you didn't create an account with <a href=\"http://www.annonces.rnu.tn/\">annonce.tn</a>, you can safely delete this email.</p>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "          <!-- end copy -->\n" +
                "\n" +
                ...
                "              <p style=\"margin: 0;\">Cheers,<br> Annaonce.tn</p>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "          <!-- end copy -->\n" +
                "\n" +
